...
QT_MOC_LITERAL(1, 10, 8), // "writeEnd"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 10) // "receiveEnd"

    },
    "tcpSocket\0writeEnd\0\0receiveEnd"
};
...
void tcpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->writeEnd(); break;
        case 1: _t->receiveEnd(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&tcpSocket::writeEnd)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (tcpSocket::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&tcpSocket::receiveEnd)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject tcpSocket::staticMetaObject = { {
    QMetaObject::SuperData::link<abstractSocket::staticMetaObject>(),
...
void *tcpSocket::qt_metacast(const char *_clname)
{
    ...
    return abstractSocket::qt_metacast(_clname);
}

int tcpSocket::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = abstractSocket::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 2)
...
// SIGNAL 0
void tcpSocket::writeEnd()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void tcpSocket::receiveEnd()
{
