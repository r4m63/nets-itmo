...
#include <memory>
#include "../src/dialogs/logdialog.h"
...
QT_MOC_LITERAL(1, 10, 15), // "changeInterface"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 11), // "receiveData"
QT_MOC_LITERAL(4, 39, 5), // "frame"
QT_MOC_LITERAL(5, 45, 2), // "fr"
QT_MOC_LITERAL(6, 48, 4), // "port"
QT_MOC_LITERAL(7, 53, 8) // "sendData"

    },
    "logDialog\0changeInterface\0\0receiveData\0"
    "frame\0fr\0port\0sendData"
};
...
void logDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->sendData((*reinterpret_cast< frame(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (logDialog::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&logDialog::changeInterface)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void logDialog::changeInterface(QString _t1)
{
