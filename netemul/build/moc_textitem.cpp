...
#include <memory>
#include "../src/graphics/textitem.h"
...
QT_MOC_LITERAL(1, 9, 9), // "lostFocus"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 9), // "textItem*"
QT_MOC_LITERAL(4, 30, 4) // "note"

    },
    "textItem\0lostFocus\0\0textItem*\0note"
};
...
void textItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->lostFocus((*reinterpret_cast< textItem*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< textItem* >(); break;
            }
            break;
        }
        ...
        {
            using _t = void (textItem::*)(textItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&textItem::lostFocus)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void textItem::lostFocus(textItem * _t1)
{
